...
function DetailsHeaderFlatListInner(props, ref) {
  const {
    backgroundColor,
...
export const DetailsHeaderFlatList = /*#__PURE__*/React.forwardRef(DetailsHeaderFlatListInner);
//# sourceMappingURL=DetailsHeaderFlatList.js.map