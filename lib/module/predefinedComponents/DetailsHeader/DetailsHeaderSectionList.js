...
function DetailsHeaderSectionListInner(props, ref) {
  const {
    backgroundColor,
...
export const DetailsHeaderSectionList = /*#__PURE__*/React.forwardRef(DetailsHeaderSectionListInner);
//# sourceMappingURL=DetailsHeaderSectionList.js.map